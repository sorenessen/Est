...
Conceptually:
    ...
    manifested Ester
      -> physical presence
      -> spatial/social interaction with Person A
      -> authoritative encounter generated by gameplay
      -> Ester leaves
      -> later return
      -> Person A recognizes the same Ester

That later proof is where physical embodiment and enough presentation to
support spatial interaction become relevant.

This proof intentionally stops one layer earlier.
